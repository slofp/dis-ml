	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-transparent bg-background hover:bg-muted hover:text-foreground dark:bg-input/30 dark:border-transparent dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground",
