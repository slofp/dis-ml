...
<TabsPrimitive.Trigger
	...
	class={cn(
		...
		"data-active:bg-background dark:data-active:text-foreground dark:data-active:border-transparent dark:data-active:bg-input/30 data-active:text-foreground",
